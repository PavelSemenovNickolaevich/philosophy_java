package practice.thread.hw;


import practice.thread.hw.model.RobotDetail;
import practice.thread.hw.model.Scientist;
import practice.thread.hw.thread.Factory;
import practice.thread.hw.thread.Night;
import practice.thread.hw.thread.ScientistAssistant;
import practice.thread.hw.util.RandomUtil;
import practice.thread.hw.util.ThreadUtil;
