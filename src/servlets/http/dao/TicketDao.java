package servlets.http.dao;

import servlets.http.entity.Ticket;
import servlets.http.util.ConnectionManager;
...
public class TicketDao implements Dao<Long, Ticket> {
    ...
    public List<Ticket> findAllByFlightId(Long flightId) {
        try (var connection = ConnectionManager.get();
            ...
            while (resultSet.next()) {
                tickets.add(builtTicket(resultSet));
            }
            return tickets;
    ...
    private Ticket builtTicket(ResultSet resultSet) throws SQLException {
        return new Ticket(
